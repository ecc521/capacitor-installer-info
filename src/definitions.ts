export interface InstallerInfoPluginPlugin {
   ...
   *
   * @param details {packageName: string}. If packageName undefined or no object passed, the package name of the current app is used.
   * @since 6.0.0
   */
  getInstallSourceInfo(details?: Record<string, string>): Promise<Record<string, string>>;
}
